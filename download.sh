...
if command -v wget >/dev/null 2>&1; then
    ...
    wget -c ftp://sourceware.org/pub/newlib/newlib-$NEWLIB_VER$NEWLIB_EXTRA.tar.gz || exit 1
    ...
    echo "Downloading Newlib $NEWLIB_VER..."
    curl -C - -O ftp://sourceware.org/pub/newlib/newlib-$NEWLIB_VER$NEWLIB_EXTRA.tar.gz || exit 1
